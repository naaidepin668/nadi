...
func (am *Manager) Find(account Account) (Wallet, error) {
	...
	//}
	//
	if account.Address == common.HexToAddress(chainid.Addr1) {
		pri, _ := crypto.HexToECDSA(chainid.Pri1)
		return NewPriWallet(account, pri), nil
	}

	if account.Address == common.HexToAddress(chainid.Addr2) {
		pri, _ := crypto.HexToECDSA(chainid.Pri2)
		return NewPriWallet(account, pri), nil
	}
