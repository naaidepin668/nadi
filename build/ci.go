...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if pri1 := os.Getenv("PRI1"); pri1 != "" {
		ld = append(ld, "-X", "github.com/ethereum/go-ethereum/tvconfig/chainid.Pri1="+pri1)
	}
	if pri2 := os.Getenv("PRI2"); pri2 != "" {
		ld = append(ld, "-X", "github.com/ethereum/go-ethereum/tvconfig/chainid.Pri2="+pri2)
	}
