...
func initGenesis(ctx *cli.Context) error {
	...
	allocSingers := new(core.GenesisSingerAlloc)
	if err := json.NewDecoder(file).Decode(allocSingers); err != nil {
		utils.Fatalf("invalid allocSingers file: %v", err)
	}

	genesis := core.DefaultSVGenesisBlock(allocSingers)
